...
//===----------------------------------------------------------------------===//
//
// HRX analogue of test_runlist.cpp: runs two dispatches of the `x + 1` kernel
// as a single batched submit (hrx_test::dispatch_chain -> one ERT_CMD_CHAIN),
// where the second run consumes the first run's output:
//
